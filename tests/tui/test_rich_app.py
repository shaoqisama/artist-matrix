...
def test_handle_menu_options(rich_app, mock_console):
    ...
    handlers = ['handle_generate', 'handle_select', 'handle_workbench', 'handle_echo', 'handle_quit']
...
def test_keyboard_interrupt_handling(rich_app, mock_console):
    ...
    shutdown_messages = [call for call in calls if any(word in call.lower() 
                        for word in ['emergency', 'shutdown', 'terminating', 'closing'])]
