...
- Key env vars (`.env`) include `ARTIST_MATRIX_PERSONA_PROVIDER`, `ARTIST_MATRIX_PERSONA_MODEL`, `ARTIST_MATRIX_PERSONA_API_KEY`, optional `ARTIST_MATRIX_PERSONA_LOG_DIR`, and avatar equivalents. Copy `.env.example` and adjust per provider.
